...
mongoose.connect('mongodb+srv://Ahng:1234@mongo-memo.ccofp.mongodb.net/mongo-memo?retryWrites=true&w=majority');
...
var completedMemoModel = mongoose.model('CompletedMemo', completedMemo);
